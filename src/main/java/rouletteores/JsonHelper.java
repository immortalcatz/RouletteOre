...
public class JsonHelper
{
	...
	public static JsonObject ReadObjectFromFile(File file)
	{
		...
		{
			RouletteOres.logger.log(Level.ERROR, "An error occured while loading JSON from file:", e);
	...
	public static void WriteToFile(File file, JsonElement json)
	{
		...
		{
			RouletteOres.logger.log(Level.ERROR, "An error occured while saving JSON to file:", e);
			return;
		}
	}
}
